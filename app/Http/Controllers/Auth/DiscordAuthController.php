...
class DiscordAuthController extends Controller
{
    public function __invoke()
    {
        ...
        if ($code == null)
        {
            return redirect('https://discordapp.com/api/oauth2/authorize?client_id=554051836114501663&redirect_uri=https%3A%2F%2Faplikacje.strefarp.pl%2Fauth&response_type=code&scope=identify%20guilds');
        }
